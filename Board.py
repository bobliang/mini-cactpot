...
class Board:
	...
	def display(self):
		...
		print (" MINI  CACTPOT ")
		print ("*=============*")
		print ("||", self.visible[0][0], "|", self.visible[0][1], "|", self.visible[0][2], "||")
		print ("||---|---|---||")
		print ("||", self.visible[1][0], "|", self.visible[1][1], "|", self.visible[1][2], "||")
		print ("||---|---|---||")
		print ("||", self.visible[2][0], "|", self.visible[2][1], "|", self.visible[2][2], "||")
		print ("*=============*")
		print ("")
		print ("Scoring:")
		for i in range(6, 10):
